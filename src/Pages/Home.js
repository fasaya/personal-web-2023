...
const Home = () => (
	<>
		...
		<div className="w-full px-4 mx-auto max-w-8xl text-custom-grey-light">
					...
					<div className="flex w-full">
						<div className="flex-auto max-w-4xl min-w-0 pt-6 lg:px-8 lg:pt-8 pb:12 xl:pb-24 lg:pb-16">
							<div className="pb-4 mb-8 border-b border-gray-200 dark:border-gray-800">
								<aside
									className="mb-5"
									aria-label="Integration requires React"
								>
									<span className="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
										<span className="text-xs bg-blue-600 rounded-full text-white px-3 py-1.5 mr-3">
											<svg
												aria-hidden="true"
												focusable="false"
												data-prefix="fab"
								...
								<p className="mb-4 text-lg text-gray-500 dark:text-gray-400">
									Learn how to install Tailwind CSS with
									Flowbite for your React project and start
									developing modern web applications using
									interactive elements based on utility
									classes
								</p>
							</div>
							<div id="mainContent" className="text-gray-400">
								<p>
									React is one of the most popular front-end
									libraries in the world used by websites such
									as Facebook, Instagram, Yahoo Mail, Dropbox,
									and more built by the Meta (formerly
									Facebook) company.
								</p>
								<p>
									React is one of the most popular front-end
								...
								<p>
									...
									components from Flowbite you will be able to
									develop applications faster than ever based
									on the{" "}
								...
								<div className="mb-8">
									...
									<nav id="TableOfContents">
										<ul>
											<li>
												<a
													href="#install-tailwind-css-with-react"
